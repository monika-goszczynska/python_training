...
class TestAddAddress(unittest.TestCase):
    ...
    def test_add_address(self):
        ...
        self.add_new_address(Address(first_name="fname", middle_name="mname", last_name="lname", nickname="nickname", title="title", company="company", address="address", home_telephone="hometel",
    ...
    def test_add_empty_address(self):
        self.login(username="admin", password="secret")
        self.add_new_address(Address(first_name="", middle_name="", last_name="", nickname="", title="", company="", address="", home_telephone="",
