...
def app(request):
    fixture = Application
    #w PyTest klasa testowa nie jest potrzebna. Fiktura przechodzi w funkcje testowa jako parametr
...
def test_add_address(app):
    ...
    app.add_new_address(Address(first_name="fname", middle_name="mname", last_name="lname", nickname="nickname", title="title", company="company", address="address", home_telephone="hometel",
...
def test_add_empty_address(app):
    app.login(username="admin", password="secret")
    app.add_new_address(Address(first_name="", middle_name="", last_name="", nickname="", title="", company="", address="", home_telephone="",
